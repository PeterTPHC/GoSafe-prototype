...
const adminProcessData=[
  ...
  {id:'PRC-240828-0117',dossierKey:'policy-main',type:'Transactionele communicatie',ref:'COM-POL-2026-00184-01',policy:'POL-2026-00184',holder:'Voorbeeld Media B.V.',status:'action_required',step:'Hard bounce beoordelen',age:'14m 08s',sla:'aandacht',started:'28 aug · 09:51',attempts:'1 / 3',error:'EMAIL_HARD_BOUNCE',steps:[['Bericht en bijlagen bevriezen','completed','polis + nota · template v4'],['Bericht aanbieden','completed','provider msg em-8817'],['Provideracceptatie','completed','provider accepted'],['Afleverevent verwerken','failed','hard bounce · mailbox bestaat niet'],['Contact corrigeren en opnieuw aanbieden','waiting','werkvoorraad · communicatie']]},
