...
const dossierData={
  ...
  'application-fallout':{
    phase:'Aanvraag',status:'Concept',statusClass:'gray',dossier:'DOS-2026-00829',policy:'—',holder:{name:'J. de Vries',type:'Particulier',kvk:'—',email:'j.devries@example.nl',phone:'06 12 34 56 78',address:{postalCode:'1161 AA',houseNumber:'18',addition:'',street:'Spaarndammerdijk',city:'Zwanenburg',countryCode:'NL',validationSource:'address_lookup',validatedAt:'2026-08-25T21:17:00Z'},iban:'NL23 INGB 0001 2345 67',tax:'Niet van toepassing'},product:'Instrumentenverzekering',received:'25 aug 2026 · 21:18',start:'5 sep 2026',amount:'€ 112.500',premium:'€ 703,13',items:[{name:'Steinway & Sons vleugel',category:'Toetsinstrumenten / Vleugel',serial:'S-418228',receipt:'Piano Atelier · 14-06-2025',amount:'€ 87.500',premium:'€ 546,88'},{name:'Franse cello',category:'Snaarinstrumenten / Cello',serial:'CEL-1884-021',receipt:'Taxatierapport · 11-08-2026',amount:'€ 25.000',premium:'€ 156,25'}],addons:[['Inhuur','Niet meeverzekerd'],['Verhuur','Niet meeverzekerd']],acceptance:{label:'Niet ingediend',className:'gray',text:'De klant heeft de aanvraag niet afgerond. Productuitval wordt in de klantflow getoond en kan niet worden ingediend.'},application:{source:'Aanvraagstraat',language:'Nederlands',submitted:'Niet ingediend',customerType:'Particulier',start:'5 sep 2026',slot:'Niet bereikt',privacy:'Niet afgerond',collection:'Niet afgerond'},documents:[{name:'Taxatierapport cello',type:'Aankoopbewijs',date:'11 aug 2026',source:'Klant',status:'Gekoppeld',className:'green'}],activities:[
      {date:'25 aug 2026 · 21:19',actor:'Product API',source:'Aanvraagstraat',title:'Productgrens gemeld',change:'De klantflow blokkeert indienen zolang het totale verzekerde bedrag te hoog is.',detail:'€ 112.500 > € 100.000'},
      {date:'25 aug 2026 · 21:18',actor:'Klant',source:'Aanvraagstraat',title:'Concept opgeslagen',change:'De niet-afgeronde aanvraag is als concept bewaard.',detail:'Status: — → Concept'}
    ]
  },
  'policy-main':{
...
dossierData['policy-event']={...dossierData['policy-main'],dossier:'DOS-2026-00614',policy:'POL-2026-00276',holder:{...dossierData['application-main'].holder,name:'Voorbeeldbedrijf D',kvk:'55220816',email:'administratie@bedrijf-d.example',phone:'010 24 68 135'},received:'18 jun 2026 · 11:18',start:'18 jun 2026',amount:'€ 64.500',premium:'€ 806,25'};
dossierData['policy-music']={...dossierData['policy-jdevries'],dossier:'DOS-2026-00231',policy:'POL-2026-00109',holder:{...dossierData['application-fallout'].holder,name:'Voorbeeldklant E',email:'klant-e@example.nl',phone:'06 18 42 73 95'},received:'9 feb 2026 · 14:07',start:'9 feb 2026',amount:'€ 18.750',premium:'€ 117,19'};
dossierData['policy-rental']={...dossierData['policy-main'],dossier:'DOS-2025-01490',policy:'POL-2025-01142',holder:{...dossierData['application-main'].holder,name:'Voorbeeldbedrijf F',kvk:'61940725',email:'finance@bedrijf-f.example',phone:'030 55 12 804'},received:'3 dec 2025 · 09:22',start:'3 dec 2025',amount:'€ 92.300',premium:'€ 1.153,75'};
dossierData['policy-photo']={...dossierData['policy-main'],dossier:'DOS-2026-00722',policy:'POL-2026-00348',holder:{...dossierData['application-main'].holder,name:'Voorbeeldbedrijf G',kvk:'72510498',email:'info@bedrijf-g.example',phone:'070 31 49 620'},received:'7 jul 2026 · 16:34',start:'7 jul 2026',amount:'€ 31.900',premium:'€ 398,75'};
dossierData['policy-live-audio']={...dossierData['policy-main'],dossier:'DOS-2025-00806',policy:'POL-2025-00622',holder:{...dossierData['application-main'].holder,name:'Live Audio B.V.',kvk:'48172906',email:'beheer@liveaudio.example',phone:'040 22 61 904'},received:'29 aug 2025 · 10:16',start:'29 aug 2025',amount:'€ 54.752',premium:'€ 684,40'};
...
function completedNewPolicyProcess(id,dossierKey,policy,holder,started,age){
  return {id,dossierKey,type:'Nieuwe polis',ref:policy,policy,holder,status:'completed',step:'Polis actief',age,sla:'goed',started,attempts:'1 / 3',steps:[['Aanvraag accepteren','completed',started],['Polis registreren in ANVA','completed','accepted'],['Polis en nota genereren','completed','PDF-renderdienst'],['Documenten valideren en definitief opslaan','completed','stored/final'],['Klantmail met stukken aanbieden','completed','provider accepted'],['Polis activeren','completed',policy]]};
}
const adminProcessData=[
  {id:'PRC-240827-0148',dossierKey:'policy-main',type:'Mutatie',ref:'MUT-2026-00128',policy:'POL-2026-00184',holder:'Voorbeeld Media B.V.',status:'running',step:'Voorbereide polisversie activeren op 1 sep 2026',age:'18 uur 7 min',sla:'goed',started:'27 aug · 09:42',attempts:'1 / 3',steps:[['Mutatie valideren en berekenen','completed','27 aug · 09:42'],['Mutatie registreren in ANVA','completed','accepted'],['Polis en nota definitief opslaan en verzenden','completed','27 aug · 09:43'],['Activeren op ingangsdatum','waiting','1 sep 2026 · 00:00'],['Voorbereide polisversie actief maken','pending','zonder nieuwe documenten']]},
  completedNewPolicyProcess('PRC-240827-0159','policy-main','POL-2026-00184','Voorbeeld Media B.V.','25 aug · 15:30','4,8 s'),
  completedNewPolicyProcess('PRC-240504-0139','policy-jdevries','POL-2026-00312','J. de Vries','4 mei · 10:41','5,2 s'),
  {id:'PRC-240828-0127',dossierKey:'policy-studio',type:'Mutatie',ref:'MUT-2026-00131',policy:'POL-2025-00917',holder:'Studio Noord B.V.',status:'waiting_external',step:'Wacht op prolongatie',age:'17m',sla:'goed',started:'28 aug · 09:14',attempts:'1 / 3',steps:[['Mutatie valideren en akkoord vastleggen','completed','28 aug · 09:14'],['Klant informeren over documentmoment','completed','bevestiging verzonden'],['Wachten op prolongatie','waiting','12 okt 2026'],['Delta herbaseren en opnieuw toetsen','pending',''],['Registreren in ANVA en stukken verzenden','pending','voor 20 okt 2026']]},
  completedNewPolicyProcess('PRC-251012-0102','policy-studio','POL-2025-00917','Studio Noord B.V.','12 okt 2025 · 09:12','5,1 s'),
  completedNewPolicyProcess('PRC-260618-0105','policy-event','POL-2026-00276','Voorbeeldbedrijf D','18 jun · 11:18','4,6 s'),
  completedNewPolicyProcess('PRC-260209-0106','policy-music','POL-2026-00109','Voorbeeldklant E','9 feb · 14:07','4,9 s'),
  completedNewPolicyProcess('PRC-251203-0107','policy-rental','POL-2025-01142','Voorbeeldbedrijf F','3 dec 2025 · 09:22','5,0 s'),
  completedNewPolicyProcess('PRC-260707-0108','policy-photo','POL-2026-00348','Voorbeeldbedrijf G','7 jul · 16:34','4,7 s'),
  completedNewPolicyProcess('PRC-250829-0109','policy-live-audio','POL-2025-00622','Live Audio B.V.','29 aug 2025 · 10:16','5,3 s'),
  {id:'PRC-240827-0121',dossierKey:null,type:'Prolongatie',ref:'PROL-2026-08-28-A',policy:'18 polissen',holder:'Automatische prolongatierun',status:'waiting_external',step:'Wacht op ANVA-responses',age:'49m 36s',sla:'goed',started:'28 aug · 02:00',attempts:'1 / 3',steps:[['Start op laatste polisdag','completed','18 polissen'],['Nieuwe termijnen en premies berekenen','completed','18 van 18'],['Polisversies vastleggen','completed','18 van 18'],['Registratie naar ANVA','waiting','16 van 18 responses'],['Documenten en klantcommunicatie','pending','uitsluitend na ANVA-akkoord']]},
  {id:'PRC-240827-0118',dossierKey:null,type:'Royement',ref:'POL-251112-0442',policy:'POL-251112-0442',holder:'Stagecraft Europe',status:'action_required',step:'Creditnota controleren',age:'1u 25m',sla:'overschreden',started:'09:54:03',attempts:'3 / 3',error:'CREDIT_NOTE_AMOUNT_MISMATCH',steps:[['Royement vastleggen','completed','09:54:03'],['Dekking beëindigen','completed','09:54:04'],['Creditnota genereren','failed','Bedrag wijkt € 2,50 af'],['ANVA en klant bijwerken','pending','']]}
];
const adminProcessStatusMeta={running:{label:'Actief',className:'green'},waiting_dependency:{label:'Wacht afhankelijkheid',className:'blue'},waiting_timer:{label:'Gepland',className:'blue'},waiting_external:{label:'Wacht extern',className:'blue'},retry_scheduled:{label:'Retry gepland',className:'amber'},action_required:{label:'Actie nodig',className:'red'},completed:{label:'Afgerond',className:'gray'},cancelled:{label:'Geannuleerd',className:'gray'},compensated:{label:'Hersteld',className:'gray'}};
...
dossierData['policy-event'].renewalDate='18 jun 2027';
dossierData['policy-music'].renewalDate='9 feb 2027';
dossierData['policy-rental'].renewalDate='3 dec 2026';
dossierData['policy-photo'].renewalDate='7 jul 2027';
dossierData['policy-live-audio'].renewalDate='29 aug 2026';
...
function renderAdminProcessDetail(process,targetId){
  ...
  const canRetry=process.status==='action_required'||process.status==='retry_scheduled';
  target.innerHTML=`<div class="admin-card-head admin-process-detail-head"><div><span class="admin-process-eyebrow">${adminEscape(process.type)}</span><h2>${adminEscape(process.ref)}</h2><p>${adminEscape(process.id)}</p></div>${adminProcessStatus(process)}</div><div class="admin-card-body"><div class="admin-process-context"><div><span>Relatie</span><strong>${adminEscape(process.holder)}</strong></div><div><span>Polis</span><strong>${adminEscape(process.policy)}</strong></div><div><span>Doorlooptijd</span><strong>${adminEscape(process.age)}</strong></div><div><span>Pogingen</span><strong>${adminEscape(process.attempts)}</strong></div></div>${process.error?`<div class="admin-process-error"><strong>Proces vraagt aandacht</strong><code>${adminEscape(process.error)}</code></div>`:''}<div class="admin-process-steps">${process.steps.map(([name,state,meta],index)=>`<div><span class="admin-process-step-icon ${adminEscape(state)}">${adminProcessStepSymbol(state)}</span>${index<process.steps.length-1?'<i></i>':''}<section><strong>${adminEscape(name)}</strong>${meta?`<small>${adminEscape(meta)}</small>`:''}</section></div>`).join('')}</div><div class="admin-process-technical"><div><span>Business key</span><code>${adminEscape(process.ref)}</code></div><div><span>Huidige stap</span><code>${adminEscape(process.step.toLowerCase().replaceAll(' ','_'))}</code></div><div><span>Procesversie</span><code>${adminEscape(process.type.toLowerCase().replaceAll(' ','_'))}.v1</code></div></div>${canRetry?`<button class="admin-btn primary admin-process-retry" data-process-retry="${adminEscape(process.id)}" type="button">Mislukte stap opnieuw proberen</button>`:''}<p class="admin-process-realtime-note">Statuswijzigingen verschijnen automatisch via de realtime eventstroom.</p></div>`;
}
...
const adminProcessStatusOrder={action_required:0,retry_scheduled:1,running:2,waiting_timer:3,waiting_dependency:4,waiting_external:5,requested:6,completed:7,cancelled:8,compensated:9};
function orderAdminProcesses(rows){return [...rows].sort((a,b)=>(adminProcessStatusOrder[a.status]??10)-(adminProcessStatusOrder[b.status]??10));}
...
function renderDossier(key){
  ...
  set('dossierOverviewDetails',renderDetailRows([['Fase',data.phase],['Status',data.status],['Product',data.product],['Communicatietaal',data.application.language],['Aanvraag ontvangen',data.received],['Gewenste / actuele ingang',data.start],...(data.phase==='Polis'?[['Prolongatiedatum',data.renewalDate]]:[]),['Verzekerd bedrag',data.amount],['Jaarpremie',data.premium],['Voorwaarden',data.terms],['IPID',data.ipid]]));
  ...
  if(typeof renderDossierCommunication==='function')renderDossierCommunication(activeDossierKey);
